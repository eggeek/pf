...
maps=(
  ./synthetic-diag/diag-512-0.75-0p.map
  ./synthetic-diag/diag-512-0.75-0.1p.map
  ./synthetic-diag/diag-512-0.75-0.5p.map
  ./synthetic-diag/diag-512-0.75-1p.map
  ./synthetic-diag/diag-512-0.75-1.5p.map
  ./synthetic-diag/diag-512-0.75-10p.map
  ./synthetic-diag/diag-512-0.75-20p.map
)

scens=(
  ./synthetic-diag/diag-512-0.75.scen
  ./synthetic-diag/diag-512-0.75.scen
  ./synthetic-diag/diag-512-0.75.scen
  ./synthetic-diag/diag-512-0.75.scen
  ./synthetic-diag/diag-512-0.75.scen
